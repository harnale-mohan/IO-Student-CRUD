...
export class MovieFormComponent implements OnInit, OnChanges{
  ...
  onAdd(){
    let movieObj : Imovies = {...this.movieForm.value , id : this._uuid.getUniqueNumber()}
    this.emitAddMovie.emit(movieObj)
    this.movieForm.reset()
  }

  onUpdate(){
    let UPDATED_MOVIE = {...this.movieForm.value, id: this.editMovie.id}
